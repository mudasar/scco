...
{
    public class JournalVoucher : Voucher, IModel
    {
        ...
        private const string TABLE_NAME = "JV";
        ...
        public static ObservableCollection<JournalVoucher> FindByDocumentNumber(int documentNo)
        {
            ...
            var listRecord = new ObservableCollection<JournalVoucher>();
            foreach (DataRow dataRow in dataTable.Rows)
            {
                var foundRecord = new JournalVoucher();

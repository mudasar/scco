...
{
    public partial class CashVoucherWindow
    {
        private decimal _creditTotal;
        private ObservableCollection<CashVoucher> _currentItems;
        ...
        private const VoucherTypes VOUCHER_TYPE = VoucherTypes.CV;
        private bool _hasModified;


        public CashVoucherWindow()
        {
            InitializeComponent();
        ...
        {
            _hasModified = true;
            var currentItem = (CashVoucher) sender;
            ...
            switch (e.PropertyName)
            {
                ...
                case "AccountCode":
                    var account = Account.FindByCode(currentItem.AccountCode);
                    currentItem.AccountTitle = account.AccountTitle;
                    break;
        ...
        private void CurrentItemsCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            switch (e.Action)
            {
                ...
                case NotifyCollectionChangedAction.Remove:
                    ...
                    {
                        var currentItem = (CashVoucher) oldItem;
                        currentItem.Destroy();
                    }
                    UpdateTotalDebitAndTotalCredit();
                    break;
        ...
        {
            {
                _debitTotal = _currentItems.Sum(cv => cv.Debit);
                _creditTotal = _currentItems.Sum(cv => cv.Credit);
        ...
        private void btnNew_Click(object sender, RoutedEventArgs e)
        {
            ...
            int docNum = Voucher.LastDocumentNo(VoucherTypes.CV);
            Find(docNum + 1);
        }
        ...
        {
            var voucherReportWindow = new VoucherReportWindow(VOUCHER_TYPE, _voucherNumber);
        ...
        private void btnPrint_Click(object sender, RoutedEventArgs e)
        {
            ...
            ReportController.CashVoucherReports.VoucherForm(_voucherNumber);
        }
        ...
        private void OnNavigateFirst(object sender, EventArgs e)
        {
            ...
            CommitChanges(ConfirmRequired.Yes);
            Find(Voucher.FirstDocumentNo(VoucherTypes.CV));
        }
        ...
        private void OnNavigateLast(object sender, EventArgs e)
        {
            ...
            CommitChanges(ConfirmRequired.Yes);
            Find(Voucher.LastDocumentNo(VoucherTypes.CV));
        }

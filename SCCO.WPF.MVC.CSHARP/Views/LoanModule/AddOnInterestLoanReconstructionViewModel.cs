...
{
    internal class AddOnInterestLoanReconstructionViewModel : ViewModelBase
    {
            ...
            NewLoanDetails = new LoanDetails
                {
                    ...
                    LoanTerms = PreviousLoanDetails.LoanTerms,
                    InterestRate = PreviousLoanDetails.InterestRate,
        ...
        {
            AmountForReconstruction = 0m;
            AmountForReconstruction += LoanBalance;
            foreach (var particular in Particulars)
            {
                AmountForReconstruction += particular.Amount;
            }
        }
        ...
        public Result Post(int documentNumber, DateTime documentDate)
        {
            //1. loan

...
{
    public partial class MembershipTypeListDetailView : IListDetailView
    {
        private MembershipTypeCollection _lookup;
        private MembershipTypeViewModel _viewModel;

        public MembershipTypeListDetailView()
        {
            InitializeComponent();
        ...
        public void Add()
        {
            var addView = new AddMembershipTypeView();
        ...
        public void Edit()
        {
            ...
            var editView = new EditMembershipTypeView(_viewModel.SelectedItem.ID);
        ...
        public void Search()
        {
            ...
            else
            {
                ...
                var viewModel = new MembershipTypeViewModel {Collection = new MembershipTypeCollection()};
        ...
        {
            _lookup = MembershipType.CollectAll();
            _viewModel = new MembershipTypeViewModel {Collection = MembershipType.CollectAll()};
            DataContext = _viewModel;
        }
